...
import 'ea_forex_detail_screen.dart';
...
class IndicatorPageState extends State<IndicatorPage> {
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          if (snapshot.hasError) {
            ...
            if (snapshot.data.status == 'success') {
              return buildListIndi(snapshot.data.data);
            } else {
  ...
  buildListIndi(List<DataTools> toolsList) {
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      CupertinoPageRoute(
                        builder: (context) => IndicatorDetailPage(dataTools.id),
                      ),
                    );
                  },
                  child: Stack(
